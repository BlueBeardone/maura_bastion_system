...
List<ChartEvent> warMarchEvents() {
  return const [
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Drive off the wolf pack', maxUnits: 2, dc: 8),
      reward: RewardSpec(
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Rout the scavengers', maxUnits: 2, dc: 8),
      reward: RewardSpec(
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Storm the bandit camp', maxUnits: 3, dc: 10),
      reward: RewardSpec(
        kind: RewardKind.material,
        categories: [RewardCategory.creaturePart],
        unitDice: UnitDice(1, 1),
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Raid the raiders\' camp', maxUnits: 4, dc: 12),
      reward: RewardSpec(
        kind: RewardKind.material,
        categories: [RewardCategory.creaturePart],
        unitDice: UnitDice(1, 1),
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Hold the walls through the night', maxUnits: 4, dc: 11),
      reward: RewardSpec(
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Answer the challenge', maxUnits: 2, dc: 14),
      reward: RewardSpec(
        kind: RewardKind.material,
        categories: [RewardCategory.creaturePart],
        unitDice: UnitDice(1, 1),
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Break the enemy forge', maxUnits: 4, dc: 13),
      reward: RewardSpec(
    ...
    ChartEvent(
      ...
      dispatch: DispatchSpec(prompt: 'Face the Black Banner', maxUnits: 4, dc: 16),
      reward: RewardSpec(
        kind: RewardKind.material,
        categories: [RewardCategory.creaturePart],
        unitDice: UnitDice(1, 1),
